...
def extract_videos_for_conv2d(video_input_file_path, feature_output_file_path, max_frames):
    ...
    while success and count < max_frames:
        ...
        if success:
            ...
            name = feature_output_file_path + str(count) + '.jpg'
            im.save(name)
...
def scan_and_extract_videos_for_conv2d(data_dir_path, data_set_name=None, max_frames=None):
    ...
    for f in os.listdir(input_data_dir_path):
        ...
        output_feature_file_path = output_dir_path + os.path.sep + f.split('.')[0] + '.npy'
        print("extracting")
...
def main():
    ...
    data_dir_path = '/Users/paulgarnier/Desktop/Files/ChouxFleurs'
    X, Y = scan_and_extract_videos_for_conv2d(data_dir_path,data_set_name='video',max_frames=160)
    #extract_videos_for_conv2d(video_file_path, output_feature_file_path, max_frames)
    print(X[0].shape)
